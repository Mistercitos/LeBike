document.addEventListener('DOMContentLoaded', () => {
  ...
  const displayMotorcycles = (motorcycles) => {
      ...
      motorcycles.forEach((brandData) => {
          ...
          if (filteredModels.length > 0) {
              ...
              brandTitle.textContent = brandData.brand;
              ...
              filteredModels.forEach((model) => {
                  ...
                  <div class="card h-100">
                      ...
                      <div class="card-body">
                          ...
                          <p class="card-text">Precio: $${model.price}</p>
  ...
  const clearFilters = () => {
      ...
      document.getElementById('yearRange').value = new Date().getFullYear();
      document.getElementById('cylinderRange').value = 3000; // Ajusta según el máximo de cilindrada
      document.getElementById('priceRange').value = 25000;  // Ajusta según el máximo de precio
